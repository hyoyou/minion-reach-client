        ...
        return (
            <div className="game">
                <p className="directions">
                    <span className="red-underline">YOUR MISSION:</span> The minions locked us out of our banana plantation! It takes 6 minions to /REACH/ the bananas. Decipher the code to stop them!
                </p>
